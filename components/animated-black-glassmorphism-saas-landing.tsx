    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-gray-100 overflow-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/5 border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button className="hidden md:inline-flex bg-white text-black hover:bg-gray-200">Sign Up</Button>
        </div>
        {isMenuOpen && (
          <motion.div
          ...
          >
            <nav className="flex flex-col space-y-4 p-4 bg-black/50 backdrop-blur-md">
              ...
              <Button className="bg-white text-black hover:bg-gray-200 w-full">Sign Up</Button>
            </nav>
          </motion.div>
        )}
      </header>
            ...
            <motion.div className="grid md:grid-cols-3 gap-12" variants={staggerChildrenVariants}>
              {[
                ...
                >
                  ...
                  <Button className="bg-white text-black hover:bg-gray-200 w-full text-lg py-3">Choose Plan</Button>
                </motion.div>
              ))}
            </motion.div>
          </div>
